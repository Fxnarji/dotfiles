...
class PanelMACHIN3tools(bpy.types.Panel):
    ...
    def draw_group(self, context, m3, layout):
        ...
        active_group, active_child, has_group_empties, has_visible_group_empties, is_groupable, is_ungroupable, is_addable, is_removable, is_selectable, is_duplicatable, is_groupifyable, _ = get_group_polls(context)
