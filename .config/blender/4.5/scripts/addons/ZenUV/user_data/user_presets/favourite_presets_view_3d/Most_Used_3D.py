...
item_sub_1 = prefs.favourites.add()
item_sub_1.name = 'Mark Seam'
item_sub_1.category = 'Unwrap'
item_sub_1.display_text = True
item_sub_1.command = "uv.zenuv_mark_seams(action='MARK')"
item_sub_1.mode = 'OPERATOR'
item_sub_1.layout = 'ROW'
item_sub_1.layout_group = 'OPEN'
item_sub_1.icon_only = False
item_sub_1.is_icon_value = True
item_sub_1.icon = 'mark-seams_32'

item_sub_1 = prefs.favourites.add()
item_sub_1.name = 'Unmark Seam'
item_sub_1.category = 'Unwrap'
item_sub_1.display_text = True
item_sub_1.command = "uv.zenuv_mark_seams(action='UNMARK')"
item_sub_1.mode = 'OPERATOR'
item_sub_1.layout = 'AUTO'
item_sub_1.layout_group = 'NONE'
item_sub_1.icon_only = False
item_sub_1.is_icon_value = True
item_sub_1.icon = 'unmark-seams_32'

item_sub_1 = prefs.favourites.add()
item_sub_1.name = 'Mark by Angle'
item_sub_1.category = 'Unwrap'
item_sub_1.display_text = True
item_sub_1.command = 'uv.zenuv_auto_mark'
item_sub_1.mode = 'OPERATOR'
item_sub_1.layout = 'ROW'
item_sub_1.layout_group = 'NONE'
item_sub_1.icon_only = False
...
item_sub_1 = prefs.favourites.add()
item_sub_1.name = 'Sharp by Seams'
item_sub_1.category = 'Unwrap'
item_sub_1.display_text = True
item_sub_1.command = 'uv.zenuv_sharp_by_seams'
item_sub_1.mode = 'OPERATOR'
item_sub_1.layout = 'AUTO'
...
item_sub_1.display_text = True
# item_sub_1.command = "uv.zenuv_select_by_texel_density(selection_mode='TRESHOLD',treshold=0.01,sel_underrated=False,sel_overrated=False,clear_selection=True,texel_density=bpy.context.scene.zen_uv.td_props.prp_current_td)"
...
item_sub_1.category = 'UV Checker'
item_sub_1.display_text = True
item_sub_1.command = 'ZUV_PT_3DV_CheckDisplayPanel'
...
prefs.favourite_index = 12
prefs.expanded = "{'Projection': True, 'Unwrap': True, 'Texel Density': True, 'UV Checker': True, 'Pack': True, 'Margin': False, 'Unstack': False, 'Stack': True, 'Transform': True, 'Secret Panel': True, 'Display': False}"
